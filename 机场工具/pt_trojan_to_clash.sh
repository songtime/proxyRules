#!/bin/bash
#trojan://6bfc6a21-2ff8-4293-9f02-5b690a915fb4@us4.8f365af0-18b9-48f4-4683-85a7aaa33d7e.30d6a0d0.the-best-airport.com:443\?allowInsecure=1\&peer=new.download.the-best-airport.com\&sni=new.download.the-best-airport.com\&type=tcp#%F0%9F%87%BA%F0%9F%87%B8%E7%BE%8E%E5%9B%BD%2004%20%7C%20%E4%B8%93%E7%BA%BF
# trojan格式
#trojan://<password>@<host>:<port>?<query_parameters>#<remark>
# 解析输入参数
node_url="$1"
